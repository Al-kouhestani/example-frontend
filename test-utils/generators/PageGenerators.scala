...
trait PageGenerators {
  ...
  implicit lazy val arbitraryAccidentAtWorkOrIndustrialDiseasePage: Arbitrary[AccidentAtWorkOrIndustrialDiseasePage.type] =
    Arbitrary(AccidentAtWorkOrIndustrialDiseasePage)
